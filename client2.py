...
while True:
	...
	while True:
		if buffer=="You have already picked this player!" or buffer=="Entered player is invalid or not in the top picks." or buffer=="Player 1 has already picked this player!":
